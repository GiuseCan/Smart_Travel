    ...
    >
      <div class="flex items-center">
        <div class="flex items-center">
          <router-link
            to="/"
            class="text-blue-300 font-bold text-5xl m-5 drop-shadow-lg"
          >
            Travello
          </router-link>
        </div>
      ...
      >
        <nav>
          <a
            ...
            href="#"
          >
            <i class="fas fa-file-alt mr-2"></i>Manage Locations
          </a>
          <a
            class="block text-gray-500 py-2.5 px-4 my-4 rounded transition duration-200 hover:bg-gradient-to-r hover:from-cyan-500 hover:to-cyan-500 hover:text-white"
            href="#"
          >
            <i class="fas fa-file-alt mr-2"></i>Manage Users
          </a>
          <a
            class="block text-gray-500 py-2.5 px-4 my-4 rounded transition duration-200 hover:bg-gradient-to-r hover:from-cyan-500 hover:to-cyan-500 hover:text-white"
            href="#"
          >
            <i class="fas fa-users mr-2"></i>Manage Booking
          </a>
          <a
            class="block text-gray-500 py-2.5 px-4 my-4 rounded transition duration-200 hover:bg-gradient-to-r hover:from-cyan-500 hover:to-cyan-500 hover:text-white"
            href="#"
          >
            <i class="fas fa-store mr-2"></i>Manage Static and Report
          </a>
        </nav>
